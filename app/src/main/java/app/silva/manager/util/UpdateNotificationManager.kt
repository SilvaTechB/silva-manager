...
import app.silva.manager.util.UpdateNotificationManager.Companion.CHANNEL_FCM_UPDATES
import app.silva.manager.util.UpdateNotificationManager.Companion.EXTRA_TRIGGER_UPDATE_CHECK
 ...
 * [app.silva.manager.ManagerApplication.onCreate].
 */
class UpdateNotificationManager(private val context: Context) {
     ...
     * Called from [app.silva.manager.worker.UpdateCheckWorker] on non-GMS devices
     * and from [app.silva.manager.service.SilvaFcmService] on GMS devices.
     */
     ...
     * [app.silva.manager.ui.viewmodel.MainViewModel.pendingUpdateCheck].
     */

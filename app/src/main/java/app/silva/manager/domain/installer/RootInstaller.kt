package app.silva.manager.domain.installer
...
import app.silva.manager.IRootSystemService
import app.silva.manager.service.ManagerRootService
...
class RootInstaller(
    ...
    private suspend fun migrateModuleIfNeeded(packageName: String) = withContext(Dispatchers.IO) {
        ...
        val newModulePath = "$MODULES_PATH/$packageName-silva"
    ...
    suspend fun mount(packageName: String) {
        ...
        withContext(Dispatchers.IO) {
            ...
            // Try new path first
            var patchedAPK = "$MODULES_PATH/$packageName-silva/$packageName.apk"
    ...
    suspend fun install(
        ...
        val modulePath = "$MODULES_PATH/$packageName-silva"
    ...
    suspend fun uninstall(packageName: String) {
        ...
        // Try new path first
        var moduleDir = remoteFS.getFile("$MODULES_PATH/$packageName-silva")

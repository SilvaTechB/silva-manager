...
class MainViewModel(
    ...
    /**
     * Set by [app.silva.manager.MainActivity.onNewIntent] when the user taps an FCM
    ...
    /**
     * Set by [app.silva.manager.MainActivity.handleDeepLinkIntent] when the app is opened

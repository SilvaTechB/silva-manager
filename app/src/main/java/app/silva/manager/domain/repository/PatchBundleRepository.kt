package app.silva.manager.domain.repository
...
import app.silva.manager.data.redux.Action
import app.silva.manager.data.redux.ActionContext
import app.silva.manager.data.redux.Store
import app.silva.manager.data.room.AppDatabase
import app.silva.manager.data.room.AppDatabase.Companion.generateUid
import app.silva.manager.data.room.apps.installed.SelectionPayload
import app.silva.manager.data.room.bundles.PatchBundleEntity
import app.silva.manager.data.room.bundles.PatchBundleProperties
import app.silva.manager.data.room.bundles.Source
import app.silva.manager.domain.bundles.*
...
import app.silva.manager.util.syncFcmTopics
import app.silva.manager.network.utils.APIError
import io.ktor.client.plugins.ResponseException
import app.silva.manager.data.room.bundles.Source as SourceInfo
...
//            }
     ...
     *
     * Used by [app.silva.manager.worker.UpdateCheckWorker] for background update notifications.
     *

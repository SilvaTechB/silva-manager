...
import app.silva.manager.data.room.apps.installed.InstallType
import app.silva.manager.data.room.apps.installed.InstalledApp
import app.silva.manager.domain.bundles.PatchBundleSource
import app.silva.manager.domain.bundles.PatchBundleSource.Extensions.asRemoteOrNull
import app.silva.manager.domain.bundles.RemotePatchBundle
...
import app.silva.manager.domain.repository.PatchBundleRepository.Companion.DEFAULT_SOURCE_UID
import app.silva.manager.network.api.SilvaAPI
import app.silva.manager.patcher.patch.BundleAppMetadata
import app.silva.manager.patcher.patch.PatchBundleInfo
import app.silva.manager.patcher.patch.PatchBundleInfo.Extensions.toPatchSelection
import app.silva.manager.patcher.split.SplitApkInspector
import app.silva.manager.patcher.split.SplitApkPreparer
import app.silva.manager.ui.model.HomeAppItem
import app.silva.manager.ui.model.SelectedApp
import app.silva.manager.util.*
import app.silva.manager.util.PatchSelectionUtils.filterGmsCore
import app.silva.manager.util.PatchSelectionUtils.resetOptionsForPatch
import app.silva.manager.util.PatchSelectionUtils.togglePatch
...
class HomeViewModel(
    ...
    private val morpheAPI: SilvaAPI,

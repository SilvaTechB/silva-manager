...
package app.silva.manager.worker
...
import app.silva.manager.worker.UpdateCheckInterval.HOURLY
...
class UpdateCheckWorker(
     ...
     * Delegates to [SilvaAPI.getAppUpdate] which handles semver comparison,

...
package app.silva.manager.ui.screen.settings.advanced
...
import app.silva.manager.domain.manager.PatchOptionsPreferencesManager.Companion.CUSTOM_HEADER_INSTRUCTION
import app.silva.manager.domain.manager.PatchOptionsPreferencesManager.Companion.CUSTOM_ICON_INSTRUCTION
import app.silva.manager.domain.manager.PatchOptionsPreferencesManager.Companion.DARK_THEME_COLOR_DESC
import app.silva.manager.domain.manager.PatchOptionsPreferencesManager.Companion.DARK_THEME_COLOR_TITLE
import app.silva.manager.domain.manager.PatchOptionsPreferencesManager.Companion.LIGHT_THEME_COLOR_DESC
import app.silva.manager.domain.manager.PatchOptionsPreferencesManager.Companion.LIGHT_THEME_COLOR_TITLE
import app.silva.manager.domain.manager.getLocalizedOrCustomText
import app.silva.manager.ui.screen.home.ColorPresetItem
import app.silva.manager.ui.screen.home.ExpandableSurface
import app.silva.manager.ui.screen.home.ScrollableInstruction
import app.silva.manager.ui.screen.shared.*
import app.silva.manager.ui.viewmodel.PatchOptionKeys
import app.silva.manager.ui.viewmodel.PatchOptionsViewModel
import app.silva.manager.util.KnownApps
import app.silva.manager.util.rememberFolderPickerWithPermission
import app.silva.manager.util.toFilePath

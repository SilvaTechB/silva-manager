...
class AppIconManager(private val context: Context) {
    ...
    enum class AppIcon(
        ...
        DEFAULT(
            aliasName = "app.silva.manager.MainActivity_Default",
        ...
        LIGHT_2(
            aliasName = "app.silva.manager.MainActivity_Light_2",
        ...
        LIGHT_3(
            aliasName = "app.silva.manager.MainActivity_Light_3",
        ...
        DARK_1(
            aliasName = "app.silva.manager.MainActivity_Dark_1",
        ...
        DARK_2(
            aliasName = "app.silva.manager.MainActivity_Dark_2",
        ...
        DARK_3(
            aliasName = "app.silva.manager.MainActivity_Dark_3",
